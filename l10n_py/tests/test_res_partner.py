...
class TestResPartner(common.TransactionCase):
    ...
    def test_02_compute_ruc_dv(self):
        ...
        self.assertEqual(
            partner.ruc_dv, "9", "Dígito verificador deve ser o último caractere"
        )
    ...
    def test_07_format_ruc_method(self):
        ...
        self.assertEqual(formatted, "12345678-9", "RUC deve ser formatado com hífen")

        # Testar formatação já com hífen
        formatted = partner._format_ruc("12345678-9")
        self.assertEqual(
            formatted, "12345678-9", "RUC já formatado deve permanecer igual"
        )
    ...
    def test_08_onchange_ruc_formatting(self):
        ...
        self.assertEqual(
            partner.ruc, "12345678-9", "RUC deve ser formatado automaticamente"
        )
    ...
    def test_12_name_search_by_name(self):
        ...
        self.assertIn(partner.id, partner_ids, "Parceiro deve ser encontrado por nome")
    ...
    def test_13_name_search_by_ruc(self):
        ...
        self.assertIn(partner.id, partner_ids, "Parceiro deve ser encontrado por RUC")
    ...
    def test_14_taxpayer_type_natural(self):
        ...
        self.assertEqual(
            partner.taxpayer_type, "natural", "Tipo deve ser pessoa física"
        )
    ...
    def test_15_taxpayer_type_juridica(self):
        ...
        self.assertEqual(
            partner.taxpayer_type, "juridica", "Tipo deve ser pessoa jurídica"
        )
    ...
    def test_16_taxpayer_type_foreign(self):
        ...
        self.assertEqual(partner.taxpayer_type, "foreign", "Tipo deve ser extranjero")
        self.assertFalse(partner.ruc, "Extranjero pode não ter RUC paraguaio")
    ...
    def test_19_update_ruc_existing_partner(self):
        ...
        self.assertEqual(partner.ruc, "12345678-9", "RUC deve ser atualizado")
    ...
    def test_21_multiple_partners_different_rucs(self):
        ...
        self.assertNotEqual(partner1.ruc, partner2.ruc, "RUCs devem ser diferentes")
        self.assertTrue(
            partner1.id and partner2.id, "Ambos parceiros devem ser criados"
        )
