...
class AccountMove(models.Model):
    ...
    def _prepare_customer_data(self):
        ...
        if partner.l10n_py_document_type:
            ...
            customer_data['documentoNumero'] = partner.vat or partner.l10n_py_document_number or ''
    ...
    def _validate_edi_data(self):
        ...
        if journal.l10n_py_timbrado_validity and journal.l10n_py_timbrado_validity < fields.Date.today():
