...
class TestAccountAuthorization(common.TransactionCase):
    ...
    def test_08_compute_state_to_expire(self):
        ...
        self.assertEqual(
            authorization.state, "to_expire", "Timbrado deve estar por vencer"
        )
    ...
    def test_11_compute_remaining_numbers(self):
        ...
        self.assertEqual(
            authorization.remaining_numbers,
            expected_numbers,
    ...
    def test_16_name_get(self):
        ...
        self.assertIn(
            "001-002", name, "Nome deve conter estabelecimento e ponto de expedição"
        )
