...
class TestAccountMove(common.TransactionCase):
    ...
    def test_01_create_invoice_with_authorization(self):
        ...
        self.assertEqual(invoice.authorization_id, self.authorization,
    ...
    def test_02_compute_full_invoice_number(self):
        ...
        self.assertTrue(invoice.full_invoice_number,
                       "Número completo deve ser gerado")
        self.assertIn('001-001', invoice.full_invoice_number,
    ...
    def test_03_compute_amount_iva_10(self):
        ...
        self.assertEqual(invoice.amount_subtotal_10, 100.0,
                        "Subtotal IVA 10% deve ser 100")
        self.assertEqual(invoice.amount_iva_10, 10.0,
                        "IVA 10% deve ser 10")
    ...
    def test_04_compute_amount_iva_5(self):
        ...
        self.assertEqual(invoice.amount_subtotal_5, 100.0,
                        "Subtotal IVA 5% deve ser 100")
        self.assertEqual(invoice.amount_iva_5, 5.0,
                        "IVA 5% deve ser 5")
    ...
    def test_05_compute_amount_exempt(self):
        ...
        self.assertEqual(invoice.amount_subtotal_exempt, 100.0,
                        "Subtotal exento deve ser 100")
        self.assertEqual(invoice.amount_iva_total, 0.0,
                        "IVA total deve ser 0")
    ...
    def test_06_compute_amount_iva_mixed(self):
        ...
        self.assertEqual(invoice.amount_iva_5, 5.0,
                        "IVA 5% deve ser 5")
        self.assertEqual(invoice.amount_iva_total, 15.0,
                        "IVA total deve ser 15")
    ...
    def test_07_compute_amount_total_words(self):
        ...
        self.assertTrue(invoice.amount_total_words,
                       "Total em letras deve ser calculado")
        self.assertIn('guaraníes', invoice.amount_total_words.lower(),
    ...
    def test_09_post_with_authorization_assigns_number(self):
        ...
        self.assertFalse(invoice.invoice_number,
                        "Número não deve estar atribuído antes de confirmar")

        invoice.action_post()

        self.assertTrue(invoice.invoice_number,
                       "Número deve ser atribuído após confirmar")
        self.assertEqual(invoice.invoice_number, 1,
                        "Primeiro número deve ser 1")
    ...
    def test_10_post_sequential_numbers(self):
        ...
        self.assertEqual(invoice2.invoice_number, invoice1.invoice_number + 1,
    ...
    def test_12_purchase_invoice_without_authorization(self):
        ...
        self.assertTrue(success,
                       "Faturas de compra não devem exigir timbrado")
